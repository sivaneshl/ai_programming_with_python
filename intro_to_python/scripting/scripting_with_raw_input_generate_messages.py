...
# assignments and grade in the class. You have each of their names, number of missing assignments, and grades on a
# spreadsheet and just have to insert them into placeholders in this message you came up with:
#
...
#
# You can just copy and paste this message to each student and manually insert the appropriate values each time, but
# instead you're going to write a program that does this for you.
#
