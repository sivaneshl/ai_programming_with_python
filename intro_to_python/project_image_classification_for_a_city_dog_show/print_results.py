...
#                                                                             
# PROGRAMMER: Sivanesh Logandurai
    ...
    if (print_incorrect_dogs and 
        ...
        for key in results_dic:
            if sum(results_dic[key][3:]) == 1:
                real = ('Dog' if results_dic[key][3] == 1 else 'Not a Dog')
                classified_as = ('Dog' if results_dic[key][4] == 1 else 'Not a Dog')
                print("Filename: {:>30}    Real: {:>26}   Classifier: {:>30}"
                      .format(key, real, classified_as))
